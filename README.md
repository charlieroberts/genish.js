...
## develop & test
First, run `npm install` from within the top level of the repo directory. Next, run `npm run build` to create the library. The resulting file will be found in `dist/gen.lib.js`.
