...
freq = seq( [110,165,220], [11025] ) 
incr = div( freq, samplerate )
...
syncSweep = peek( data([220,880]), abs( phasor( .5 ) ) )
...
// otherwise add zero
dir.poke( 0, add( dir.peek(0), master.wrap ) )
 
// get a 0 or 1 value from our dir
moddir = mod( dir.peek(0), 2 )
