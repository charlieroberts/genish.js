...
module.exports = function () {
  var durations = arguments.length <= 0 || arguments[0] === undefined ? 11025 : arguments[0];
  var values = arguments.length <= 1 || arguments[1] === undefined ? [0, 1] : arguments[1];
  var phaseIncrement = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];
